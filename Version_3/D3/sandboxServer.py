...
#   then open Edge or Chrome browser with "localhost:6002"
...
image_folder_path = "/Media/img/yourLogo/"
...
class Serv(SimpleHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            elif self.path == '/Report/Sequence':
            ...
            elif self.path == '/listImageFiles':
                directory_path = './Media/img/yourLogo/'
            ...
            elif self.path.__contains__(".png") or self.path.__contains__(".jpg"):
    ...
    def do_POST(self):
        ...
        try:
            ...
            return
# ejc code to do a "proxy" call with the sandbox server    
        # sendTo = message["ovon"]["sender"]["from"]
...
# end of ejc code
        ...
        elif self.path.startswith('/D3/AssistantServers/'):
            directory_name = self.path.split('/')[-1]
            # Create the directory if it doesn't exist
            directory_path = os.path.join(os.path.dirname(__file__), '..', 'D3', 'AssistantServers', directory_name)
