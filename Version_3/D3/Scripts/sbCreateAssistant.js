async function createAssistant() {
    try {
        ...
        createAssistantDirectory(assistantName, assistantType, serviceAddress);
...
function createAssistantDirectory(assistantName, assistantType,serviceAddress) {
    var localContent = "";
    var assistantContent = "";

    var port = serviceAddress.split(':')[2] || 'defaultPort';
...
#################
port = ${port} # CHANGE THIS TO AN AVAILABLE PORT
#################
...
`;
fetch(`../D3/AssistantServers/${assistantName}Assistant`, {
    method: 'POST',
    headers: {
        'Content-Type': 'application/json',
    },
